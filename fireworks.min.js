    ...
    ***************************************************************************** */
    ...
    var s = 2 * Math.PI
      , n = function() {
        ...
        t.prototype.draw = function(t) {
            ...
            t.beginPath(),
            t.moveTo(i.x, i.y),
            t.lineTo(this.position.x, this.position.y),
            t.lineWidth = this.size,
            t.lineCap = "round",
      ...
      , e = function() {
        function s(t) {
            ...
            this.cw = n,
            this.ch = e,
            this.rocketInitialPoint = o,
            this.cannons = h,
            this.rocketInitialPoint && this.cannons.push({
    ...
    return function() {
        function t(t, i) {
            ...
            this.container = t,
            this.rocketSpawnInterval = o,
            this.maxRockets = r,
            this.cw = w,
            this.ch = m,
            this.maxH = this.ch * (1 - f),
            this.minH = this.ch * (1 - p),
            this.chance = v,
        ...
        t.prototype.start = function() {
            ...
            if (null == this.interval)
                ...
                this.rafInterval = window.requestAnimationFrame((function() {
                    return t.update()
                }
                )),
                function() {
        ...
        t.prototype.fire = function() {
            ...
            this.rafInterval || (this.rafInterval = window.requestAnimationFrame((function() {
                return t.update()
            }
            )))
        }
        ...
        t.prototype._clear = function(t) {
            ...
            this.ctx.fillStyle = "rgba(0, 0, 0 " + (t ? "" : ", 0.5") + ")",
        ...
        t.prototype._finish = function() {
            ...
            this.finishCallbacks.forEach((function(t) {
                return t()
            }
            ))
        }
        ...
        t.prototype.update = function() {
            ...
            try {
                for (var n = function(t) {
                    ...
                    o.draw(this.ctx),
                    o.update(),
                    o.shouldRemove(this.cw, this.ch) ? this.things.delete(o) : o.shouldExplode(this.maxH, this.minH, this.chance) && this.things.explode(o)
                }
            } catch (i) {
                t = {
                    error: i
